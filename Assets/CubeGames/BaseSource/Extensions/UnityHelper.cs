namespace Helpers
{
    ...
    public static class Vectors
    {
        ...
        public static List<Vector2> OrderbyAngle(IEnumerable<Vector2> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.x, x.y)).ToList();
        }

        public static List<Vector3> OrderbyAngleXY(List<Vector3> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.x, x.y)).ToList();
        }

        public static List<Vector3> OrderbyAngleXY(IEnumerable<Vector3> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.x, x.y)).ToList();
        }

        public static List<Vector3> OrderbyAngleXZ(List<Vector3> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.x, x.z)).ToList();
        }

        public static List<Vector3> OrderbyAngleXZ(IEnumerable<Vector3> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.x, x.z)).ToList();
        }

        public static List<Vector3> OrderbyAngleYZ(List<Vector3> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.z, x.y)).ToList();
        }

        public static List<Vector3> OrderbyAngleYZ(IEnumerable<Vector3> values)
        {
            return values.OrderBy(x => Mathf.Atan2(x.z, x.y)).ToList();
        }
    ...
    public static class Maths
    {
        ...
        public static int IncreaseIndex(int value, int maxValue, int minValue)
        {
            value = value + 1 < maxValue ? value + 1 : minValue;
            return value;
        }

        public static int DecreaseIndex(int value, int maxValue, int minValue)
        {
            value = value - 1 >= minValue ? value - 1 : maxValue - 1;
            return value;
        }
    ...
    public static class Collections
    {
        ...
        public static List<Vector3> ToYZ(List<Vector2> value)
        {
            List<Vector3> list = new List<Vector3>();
            foreach (var item in value)
            {
                list.Add(Vectors.ToYZ(item));
            }

            return list;
        }

        public static List<Vector3> ToXZ(List<Vector2> value)
        {
            List<Vector3> list = new List<Vector3>();
            foreach (var item in value)
            {
                list.Add(Vectors.ToXZ(item));
            }

            return list;
        }

        public static List<float> GetOnlyX(List<Vector2> values)
        {
            List<float> returnValues = new List<float>();
            foreach (var item in values)
            {
                returnValues.Add(item.x);
            }

            return returnValues;
        }

        public static List<float> GetOnlyX(List<Vector3> values)
        {
            List<float> returnValues = new List<float>();
            foreach (var item in values)
            {
        ...
        public static List<float> GetOnlyY(List<Vector2> values)
        {
            List<float> returnValues = new List<float>();
            foreach (var item in values)
            {
                returnValues.Add(item.y);
            }

            return returnValues;
        }

        public static List<float> GetOnlyY(List<Vector3> values)
        {
            List<float> returnValues = new List<float>();
            foreach (var item in values)
            {
        ...
        public static List<float> GetOnlyZ(List<Vector3> values)
        {
            List<float> returnValues = new List<float>();
            foreach (var item in values)
            {
                returnValues.Add(item.z);
            }
